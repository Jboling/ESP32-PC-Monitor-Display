...
/* Native panel resolution — DMA flush always uses these dimensions */
#define LCD_NOROT_HRES     172
#define LCD_NOROT_VRES     640

/*
 * Landscape via manual flush-time rotation (Waveshare V8 approach).
 * LVGL renders 640x172; flush rotates to native 172x640; DMA strips stay 172px wide.
 */
...
#define EXAMPLE_LCD_H_RES LCD_NOROT_HRES
#define EXAMPLE_LCD_V_RES LCD_NOROT_VRES
#else
#define EXAMPLE_LCD_H_RES LCD_NOROT_VRES
#define EXAMPLE_LCD_V_RES LCD_NOROT_HRES
#endif
